...
<body bgcolor="Black">
 ...
 <form name="f1" action = "auth13.php" onsubmit = "return validation()" method = "POST">  
...
<p><CENTER><B></B></P></CENTER>
  <div class="container">
    ...
    <label for="des"><b>Service name</b></label>
 
 <select name="des" id="des" input type="text" width="500%" style="padding: 0.5%">
              <option value="selec">Please Select</option>
              <option value="critical care">Critical care</option>
              <option value="diebaties care">Diebaties care</option>
              <option value="elder care">Elder care</option>
              
               <option value="nursing">Nursing</option>
                <option value="home isolation patient management">home isolation patient management</option>
