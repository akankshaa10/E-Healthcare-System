...
<body bgcolor="Black">
 ...
 <form name="f1" action = "auth15.php" onsubmit = "return validation()" method = "POST">  
...
<p><CENTER><B></B></P></CENTER>
  <div class="container">
    ...
    <label for="des"><b>Specialist in</b></label>
 <input type="text" placeholder="Enter mobile no" name="des" required>
