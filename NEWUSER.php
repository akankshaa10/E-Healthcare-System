...
<body bgcolor="Black">
 ...
 <form name="f1" action = "insert.php" onsubmit = "return validation()" method = "POST">  
...
<p><CENTER><B>ADMIN LOGIN</B></P></CENTER>
  <div class="container">
    ...
    <input type="email" placeholder="example@gmail.com" name="eml" required><BR><BR>
